...
Rcpp::XPtr<ResizeableNumericVariable<double>> create_resizeable_double_variable(const std::vector<double>& values);
...
std::vector<double> resizeable_double_variable_get_values(Rcpp::XPtr<ResizeableNumericVariable<double>> variable);
RcppExport SEXP _individual_resizeable_double_variable_get_values(SEXP variableSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::XPtr<ResizeableNumericVariable<double>> >::type variable(variableSEXP);
    rcpp_result_gen = Rcpp::wrap(resizeable_double_variable_get_values(variable));
    return rcpp_result_gen;
END_RCPP
}
// resizeable_double_variable_get_values_at_index
std::vector<double> resizeable_double_variable_get_values_at_index(Rcpp::XPtr<ResizeableNumericVariable<double>> variable, Rcpp::XPtr<individual_index_t> index);
...
std::vector<double> resizeable_double_variable_get_values_at_index_vector(Rcpp::XPtr<ResizeableNumericVariable<double>> variable, std::vector<size_t> index);
...
Rcpp::XPtr<individual_index_t> resizeable_double_variable_get_index_of_range(Rcpp::XPtr<ResizeableNumericVariable<double>> variable, const double a, const double b);
...
size_t resizeable_double_variable_get_size_of_range(Rcpp::XPtr<ResizeableNumericVariable<double>> variable, const double a, const double b);
...
void resizeable_double_variable_queue_fill(Rcpp::XPtr<ResizeableNumericVariable<double>> variable, const std::vector<double> value);
...
void resizeable_double_variable_queue_update(Rcpp::XPtr<ResizeableNumericVariable<double>> variable, const std::vector<double> value, std::vector<size_t> index);
...
void resizeable_double_variable_queue_update_bitset(Rcpp::XPtr<ResizeableNumericVariable<double>> variable, const std::vector<double> value, Rcpp::XPtr<individual_index_t> index);
...
void resizeable_double_variable_queue_extend(Rcpp::XPtr<ResizeableNumericVariable<double>> variable, const std::vector<double>& values);
RcppExport SEXP _individual_resizeable_double_variable_queue_extend(SEXP variableSEXP, SEXP valuesSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::XPtr<ResizeableNumericVariable<double>> >::type variable(variableSEXP);
    Rcpp::traits::input_parameter< const std::vector<double>& >::type values(valuesSEXP);
    resizeable_double_variable_queue_extend(variable, values);
    return R_NilValue;
END_RCPP
}
// resizeable_double_variable_queue_shrink_bitset
void resizeable_double_variable_queue_shrink_bitset(Rcpp::XPtr<ResizeableNumericVariable<double>> variable, Rcpp::XPtr<individual_index_t> index);
RcppExport SEXP _individual_resizeable_double_variable_queue_shrink_bitset(SEXP variableSEXP, SEXP indexSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::XPtr<ResizeableNumericVariable<double>> >::type variable(variableSEXP);
    Rcpp::traits::input_parameter< Rcpp::XPtr<individual_index_t> >::type index(indexSEXP);
    resizeable_double_variable_queue_shrink_bitset(variable, index);
    return R_NilValue;
END_RCPP
}
// resizeable_double_variable_queue_shrink
void resizeable_double_variable_queue_shrink(Rcpp::XPtr<ResizeableNumericVariable<double>> variable, std::vector<size_t> index);
RcppExport SEXP _individual_resizeable_double_variable_queue_shrink(SEXP variableSEXP, SEXP indexSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::XPtr<ResizeableNumericVariable<double>> >::type variable(variableSEXP);
    Rcpp::traits::input_parameter< std::vector<size_t> >::type index(indexSEXP);
    resizeable_double_variable_queue_shrink(variable, index);
    return R_NilValue;
END_RCPP
}
// resizeable_double_variable_size
size_t resizeable_double_variable_size(Rcpp::XPtr<ResizeableNumericVariable<double>> variable);
RcppExport SEXP _individual_resizeable_double_variable_size(SEXP variableSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::XPtr<ResizeableNumericVariable<double>> >::type variable(variableSEXP);
    rcpp_result_gen = Rcpp::wrap(resizeable_double_variable_size(variable));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::vector<int>& >::type values(valuesSEXP);
    rcpp_result_gen = Rcpp::wrap(create_resizeable_integer_variable(values));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_individual_resizeable_double_variable_queue_extend", (DL_FUNC) &_individual_resizeable_double_variable_queue_extend, 2},
    {"_individual_resizeable_double_variable_queue_shrink_bitset", (DL_FUNC) &_individual_resizeable_double_variable_queue_shrink_bitset, 2},
    {"_individual_resizeable_double_variable_queue_shrink", (DL_FUNC) &_individual_resizeable_double_variable_queue_shrink, 2},
    {"_individual_resizeable_double_variable_size", (DL_FUNC) &_individual_resizeable_double_variable_size, 1},
    {"_individual_create_resizeable_integer_variable", (DL_FUNC) &_individual_create_resizeable_integer_variable, 1},
    ...
    {"_individual_resizeable_integer_variable_update", (DL_FUNC) &_individual_resizeable_integer_variable_update, 1},

...
test_that("extending ResizeableIntegerVariable returns the new values", {
  size <- 10
  x <- ResizeableIntegerVariable$new(seq_len(size))
...
test_that("shrinking ResizeableIntegerVariable removes values (bitset)", {
  size <- 10
  x <- ResizeableIntegerVariable$new(seq_len(size))
...
test_that("shrinking ResizeableIntegerVariable removes values (vector)", {
  size <- 10
  x <- ResizeableIntegerVariable$new(seq_len(size))
  expect_equal(x$get_values(), 1:10)
...
test_that("ResizeableIntegerVariable queue/update works with verifiable input (subset update: vector)", {
...
test_that("ResizeableIntegerVariable queue/update fails with incorrect input (subset update: vector)", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size))
...
test_that("ResizeableIntegerVariable queue/update works with verifiable input (subset update: bitset)", {
...
test_that("ResizeableIntegerVariable queue/update fails with incorrect input (subset update: bitset)", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size))
...
test_that("ResizeableIntegerVariable queue/update works with verifiable input (subset fill: vector)", {
...
test_that("ResizeableIntegerVariable queue/update fails with incorrect input (subset fill: vector)", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size))
...
test_that("ResizeableIntegerVariable queue/update works with verifiable input (subset fill: bitset)", {
...
test_that("ResizeableIntegerVariable queue/update fails with incorrect input (subset fill: bitset)", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size))
...
test_that("ResizeableIntegerVariable queue/update works with verifiable input (variable reset)", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size))
  before <- variable$get_values()
...
test_that("ResizeableIntegerVariable queue/update fails with incorrect input (variable reset)", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size))
...
test_that("ResizeableIntegerVariable queue/update works with verifiable input (variable fill)", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size))
...
test_that("ResizeableIntegerVariable queue/update fails with incorrect input (variable fill)", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size))

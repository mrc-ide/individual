...
test_that("DoubleVariable queue/update works with verifiable input (subset update: vector)", {
...
test_that("DoubleVariable queue/update fails with incorrect input (subset update: vector)", {
  size <- 10
  variable <- DoubleVariable$new(seq_len(size))
...
test_that("DoubleVariable queue/update works with verifiable input (subset update: bitset)", {
...
test_that("DoubleVariable queue/update fails with incorrect input (subset update: bitset)", {
  size <- 10
  variable <- DoubleVariable$new(seq_len(size))
...
test_that("DoubleVariable queue/update works with verifiable input (subset fill: vector)", {
...
test_that("DoubleVariable queue/update fails with incorrect input (subset fill: vector)", {
  size <- 10
  variable <- DoubleVariable$new(seq_len(size))
...
test_that("DoubleVariable queue/update works with verifiable input (subset fill: bitset)", {
...
test_that("DoubleVariable queue/update fails with incorrect input (subset fill: bitset)", {
  size <- 10
  variable <- DoubleVariable$new(seq_len(size))
...
test_that("DoubleVariable queue/update works with verifiable input (variable reset)", {
  size <- 10
  variable <- DoubleVariable$new(seq_len(size))
...
test_that("DoubleVariable queue/update fails with incorrect input (variable reset)", {
  size <- 10
  variable <- DoubleVariable$new(seq_len(size))
...
test_that("DoubleVariable queue/update works with verifiable input (variable fill)", {
...
test_that("DoubleVariable queue/update fails with incorrect input (variable fill)", {

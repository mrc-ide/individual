...
test_that("ResizeableDoubleVariable queue/update works with verifiable input (subset update: vector)", {
...
test_that("ResizeableDoubleVariable queue/update fails with incorrect input (subset update: vector)", {
  size <- 10
  variable <- ResizeableDoubleVariable$new(seq_len(size))
...
test_that("ResizeableDoubleVariable queue/update works with verifiable input (subset update: bitset)", {
...
test_that("ResizeableDoubleVariable queue/update fails with incorrect input (subset update: bitset)", {
  size <- 10
  variable <- ResizeableDoubleVariable$new(seq_len(size))
...
test_that("ResizeableDoubleVariable queue/update works with verifiable input (subset fill: vector)", {
...
test_that("ResizeableDoubleVariable queue/update fails with incorrect input (subset fill: vector)", {
  size <- 10
  variable <- ResizeableDoubleVariable$new(seq_len(size))
...
test_that("ResizeableDoubleVariable queue/update works with verifiable input (subset fill: bitset)", {
...
test_that("ResizeableDoubleVariable queue/update fails with incorrect input (subset fill: bitset)", {
  size <- 10
  variable <- ResizeableDoubleVariable$new(seq_len(size))
...
test_that("ResizeableDoubleVariable queue/update works with verifiable input (variable reset)", {
  size <- 10
  variable <- ResizeableDoubleVariable$new(seq_len(size))
...
test_that("ResizeableDoubleVariable queue/update fails with incorrect input (variable reset)", {
  size <- 10
  variable <- ResizeableDoubleVariable$new(seq_len(size))
...
test_that("ResizeableDoubleVariable queue/update works with verifiable input (variable fill)", {
...
test_that("ResizeableDoubleVariable queue/update fails with incorrect input (variable fill)", {
...
test_that("ResizeableDoubleVariable extending variables returns the new values", {
  size <- 10
...
test_that("ResizeableDoubleVariable shrinking variables removes values (bitset)", {
  size <- 10
  x <- ResizeableDoubleVariable$new(seq_len(size))
...
test_that("ResizeableDoubleVariable shrinking variables removes values (vector)", {
  size <- 10
  x <- ResizeableDoubleVariable$new(seq_len(size))
  expect_equal(x$get_values(), 1:10)
...
test_that("ResizeableDoubleVariable resizing variables returns the correct size", {
  size <- 10
  x <- ResizeableDoubleVariable$new(seq_len(size))
...
test_that("ResizeableDoubleVariable resizing operations preserve order", {
  size <- 10
  x <- ResizeableDoubleVariable$new(seq_len(size))
  x$queue_shrink(index = 5:10)
  x$queue_extend(values = seq_len(size) + 10)
...
test_that("ResizeableDoubleVariable invalid shrinking operations error at queue time", {
  size <- 10
  x <- ResizeableDoubleVariable$new(seq_len(size))

test_that("Creating ResizeableIntegerVariables errors with bad input", {
  expect_error(ResizeableIntegerVariable$new(NULL))
  expect_error(ResizeableIntegerVariable$new(NaN))
  expect_error(ResizeableIntegerVariable$new(c(1,NaN)))
  expect_error(ResizeableIntegerVariable$new(NA))
  expect_error(ResizeableIntegerVariable$new(c(1,NA)))
  expect_error(ResizeableIntegerVariable$new(Inf))
  expect_error(ResizeableIntegerVariable$new(c(1,Inf)))
  expect_error(ResizeableIntegerVariable$new(-Inf))
  expect_error(ResizeableIntegerVariable$new(c(1,-Inf)))
  expect_error(ResizeableIntegerVariable$new("1"))
})

test_that("ResizeableIntegerVariable get values returns correct values without index", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size))
  expect_equal(variable$get_values(), 1:10)
  
  variable <- ResizeableIntegerVariable$new(seq_len(size) + 10)
...
test_that("ResizeableIntegerVariable get values returns correct values with vector index", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size))
...
test_that("ResizeableIntegerVariable get values returns correct values with bitset index", {
  size <- 10
  variable <- ResizeableIntegerVariable$new(seq_len(size) + 10)
  expect_equal(variable$get_values(Bitset$new(size = size)$insert(5:10)), 15:20)
})

test_that("ResizeableIntegerVariable get values fails with incorrect index", {
  variable <- ResizeableIntegerVariable$new(initial_values = 1:100)
  b <- Bitset$new(1000)
...
test_that("ResizeableIntegerVariable get index of set works correctly", {
  variable <- ResizeableIntegerVariable$new(5:10)
  ...
  variable <- ResizeableIntegerVariable$new(-10:10)
  indices <- variable$get_index_of(set = c(-2,-1,1,2))
  expect_equal(indices$to_vector(), c(9, 10, 12, 13))
})

test_that("ResizeableIntegerVariable get index of set fails with incorrect set", {
  variable <- ResizeableIntegerVariable$new(1:10)
...
test_that("ResizeableIntegerVariable get index of bounds [a,b] works correctly", {
  variable <- ResizeableIntegerVariable$new(5:10)
...
test_that("ResizeableIntegerVariable get index of bounds [a,b] fails with incorrect bounds", {
  variable <- ResizeableIntegerVariable$new(5:10)
...
test_that("ResizeableIntegerVariable get size of set works correctly", {
  variable <- ResizeableIntegerVariable$new(-10:10)
  set <- c(-2,-1,1,2) 
...
test_that("ResizeableIntegerVariable get size of set fails with incorrect input", {
  variable <- ResizeableIntegerVariable$new(-10:10)
...
test_that("ResizeableIntegerVariable get size of set in bounds [a,b] works correctly", {
  variable <- ResizeableIntegerVariable$new(-10:10)
...
test_that("ResizeableIntegerVariable get size of set in bounds [a,b] fails with incorrect input", {
  variable <- ResizeableIntegerVariable$new(-10:10)
...
test_that("ResizeableIntegerVariable get size and index of set in bounds [a,b] and set gives same answer for equal intervals", {
  variable <- ResizeableIntegerVariable$new(-10:10)
